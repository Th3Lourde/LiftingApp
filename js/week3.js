...
function week1Day1(){
  number = Math.round(liftingNumber(selected[1], .85 ));
  // alert(number);
  $('#day').text('Day 1');
  $('#description').text(' - Lower Body');

  // Changes the name of the first list
  $('.excercise-1-name').text('Squat');
  // Changes the weight that will be lifted
  $('.excercise-1-1-weight').text(number+5);
  $('.excercise-1-2-weight').text(number+5);
  $('.excercise-1-3-weight').text(number+5);
  ...
  number = Math.round(liftingNumber(selected[2], .875 ));
  ...
  // Changes the rep scheme
  $('.excercise-2-1-reps').text('x3-6');
  $('.excercise-2-2-reps').text('x3-6');
